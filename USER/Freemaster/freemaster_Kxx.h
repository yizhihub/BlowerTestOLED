...
****************************************************************************//*!
*
* @brief  FreeMASTER Driver hardware dependent stuff  modifed by lgd to other platform.
*
*******************************************************************************/
...
/* SCI Status registers bits modify to STM32F10x(GD32F10x) by lgd*/
#define FMSTR_SCISR_TDRE       (1 << 7)//USART_FLAG_TBE    //USART_FLAG_TXE// Tx Register empty   // usart_flag_get(USART1, USART_FLAG_RBNE)
#define FMSTR_SCISR_TC         (1 << 6)//USART_FLAG_TC     //USART_FLAG_TC// TX  Tx complete, namly Tx Register empty 
#define FMSTR_SCISR_RDRF       (1 << 5)//USART_FLAG_RBNE  //USART_FLAG_RXNE// Rx full flag 
#define FMSTR_SCISR_IDLE       (1 << 4)//USART_FLAG_IDLE  // USART_FLAG_IDLE// idle 
#define FMSTR_SCISR_OR         (1 << 3)//USART_FLAG_ORERR                  // USART_FLAG_ORE// over run err flg
#define FMSTR_SCISR_NF         (1 << 2)//USART_FLAG_NERR //USART_FLAG_NE// noise err flg
#define FMSTR_SCISR_FE         (1 << 1)//USART_FLAG_FERR //USART_FLAG_FE// frame err flag 
#define FMSTR_SCISR_PF         (1 << 0)//USART_FLAG_PERR //USART_FLAG_PE// parttiy err flag 
...
#define FMSTR_SCI_TE() usart_transmit_config(FMSTR_UART, USART_TRANSMIT_ENABLE)//FMSTR_UART->CR1 |= USART_Mode_Tx
/* avoid modify freemaster_serial.c, for HC32F140 TXE can not be set false when FMSTR_Listen(), GD32F10x too */
#define FMSTR_SCI_TD() usart_transmit_config(FMSTR_UART, USART_TRANSMIT_DISABLE)//FMSTR_UART->CR1 |= USART_Mode_Tx 
...
#define FMSTR_SCI_RE() usart_receive_config(FMSTR_UART, USART_RECEIVE_ENABLE)//FMSTR_UART->CR1 |= USART_Mode_Rx  
#define FMSTR_SCI_RD() usart_receive_config(FMSTR_UART, USART_RECEIVE_DISABLE)//FMSTR_UART->CR1 &= ~USART_Mode_Rx
    
//#define FMSTR_SCI_TE_RE() FMSTR_SETBIT8(FMSTR_SCI_BASE, FMSTR_SCIC2_OFFSET, FMSTR_SCIC2_RE | FMSTR_SCIC2_TE)
#define FMSTR_SCI_TE_RE() usart_transmit_config(FMSTR_UART, USART_TRANSMIT_ENABLE);usart_receive_config(FMSTR_UART, USART_RECEIVE_ENABLE)//FMSTR_UART->CR1 |= (USART_Mode_Tx | USART_Mode_Rx)
...
#define FMSTR_SCI_ETXI() usart_interrupt_enable(FMSTR_UART,USART_INT_TBE)
#define FMSTR_SCI_DTXI() usart_interrupt_disable(FMSTR_UART,USART_INT_TBE)
...
#define FMSTR_SCI_ERXI() usart_interrupt_enable(FMSTR_UART,USART_INT_RBNE)
#define FMSTR_SCI_DRXI() usart_interrupt_disable(FMSTR_UART,USART_INT_RBNE)

/* Tranmsit character */
//#define FMSTR_SCI_PUTCHAR(ch) FMSTR_SETREG8(FMSTR_SCI_BASE, FMSTR_SCIDR_OFFSET, ch)
#define FMSTR_SCI_PUTCHAR(ch) USART_DATA(FMSTR_UART) = ch

/* Get received character */
//#define FMSTR_SCI_GETCHAR() FMSTR_GETREG8(FMSTR_SCI_BASE, FMSTR_SCIDR_OFFSET)
#define FMSTR_SCI_GETCHAR() USART_DATA(FMSTR_UART)

/* read status register */
//#define FMSTR_SCI_GETSR() FMSTR_GETREG8(FMSTR_SCI_BASE, FMSTR_SCIS1_OFFSET)
#define FMSTR_SCI_GETSR() USART_STAT0(FMSTR_UART)
...
#define FMSTR_SCI_RDCLRSR() USART_STAT0(FMSTR_UART); /* FMSTR_UART->SR &= ~(USART_FLAG_IDLE | USART_FLAG_ORE| USART_FLAG_NE | USART_FLAG_FE | USART_FLAG_PE)   */
#else                                                         
