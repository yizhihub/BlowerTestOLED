...
#define FMSTR_SCI_BASE         0x4006B000u   /* UART1 base on KV30 */
#define FMSTR_SCI_INTERRUPT    49            /* UART1 interrupt vector on K60 */

#include "gd32f30x_usart.h"
#define FMSTR_UART USART1
...
#define FMSTR_REC_TIMEBASE     FMSTR_REC_BASE_MICROSEC(33) /* 0 = "unknown" */
